<header class="header sticky top-0 bg-slate-800 shadow-2xl flex items-center justify-between px-8 py-5 z-50" id="navbar">
    ...
    <!-- Search bar -->
    <form action="/search" method="get" class="h-14 justify-center flex flex-row w-1/2">
        <input type="text" placeholder="Search..." class="text-white font-maven font-bold h-14 w-4/5 rounded-2xl text-center bg-black-50 border-0 focus:ring-yellow-400" name="query">
        <button type="submit" value="query"><i class="fa-solid fa-magnifying-glass px-5 hover:text-yellow-400 transition-all text-2xl"></i></button>
    </form>
